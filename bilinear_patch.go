...
func (patch *BilinearPatch) EvaluateColor(u, v float32) mgl32.Vec3 {
	return EvaluateBilinearVec3(patch.Color00, patch.Color10, patch.Color01, patch.Color11, u, v)
}
...
func (patch *BilinearPatch) Dice(grid *Grid, dicingRate float32, screenBoundBox BoundBox) (int, int) {
